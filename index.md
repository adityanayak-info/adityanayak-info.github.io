...
- <span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#123C69" width="20" height="20" style="display:inline-block;vertical-align:-3px;margin-right:4px"><path d="M12 2l2.9 6.26 6.1.53-4.6 4.01 1.38 5.7L12 15.4 6.22 18.5 7.6 12.8 3 8.79l6.1-.53z"/></svg></span>**Selected as a HAIL Graduate Student Awardee**, [Hub for AI and Data Science Leadership, University of Pittsburgh (2026–27)](https://www.aihub.pitt.edu/building-knowledge/hail-graduate-student-awardee-program){:target="_blank"} — *interdisciplinary cohort on responsible data science and AI*
